...
Game.prototype.createScore = function() {
  this.score = new Score(0, incrimentInScore);
}

Game.prototype.isGameOver = function() {
  return this.snake.isColliedItSelf() || this.HasColliedWithWall();
}

Game.prototype.HasColliedWithWall = function() {
  return this.snake.isWithinRange(this.topLeft, this.bottomRight);
}
